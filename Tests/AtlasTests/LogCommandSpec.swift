    ...
    override func spec() {
        ...
        describe("Log") {
            ...
            context("running") {
                ...
                beforeEach {
                    print("STDOUT_FILENO: \(STDOUT_FILENO)")
                    print("INPUT: \(self.inputPipe.fileHandleForWriting.fileDescriptor)")
...
//                    state that you want to be notified of any data coming across the pipe
                    ...
                    print("STDOUT_FILENO2: \(STDOUT_FILENO)")
                    print("INPUT2: \(self.inputPipe.fileHandleForWriting.fileDescriptor)")
